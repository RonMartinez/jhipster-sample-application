...
import io.github.jhipster.application.repository.GameTeamRepository;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.GameTeam}.
 */
@RestController
@RequestMapping("/api")
public class GameTeamResource {
    ...
    public ResponseEntity<GameTeam> updateGameTeam(@RequestBody GameTeam gameTeam) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, gameTeam.getId().toString()))
            .body(result);
    }
