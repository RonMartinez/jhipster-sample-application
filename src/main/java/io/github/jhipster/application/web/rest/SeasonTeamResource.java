...
import io.github.jhipster.application.repository.SeasonTeamRepository;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.SeasonTeam}.
 */
@RestController
@RequestMapping("/api")
public class SeasonTeamResource {
    ...
    public ResponseEntity<SeasonTeam> updateSeasonTeam(@RequestBody SeasonTeam seasonTeam) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, seasonTeam.getId().toString()))
            .body(result);
    }
