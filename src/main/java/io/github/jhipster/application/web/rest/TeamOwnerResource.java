...
import io.github.jhipster.application.domain.TeamOwner;
import io.github.jhipster.application.repository.TeamOwnerRepository;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.TeamOwner}.
 */
@RestController
@RequestMapping("/api")
public class TeamOwnerResource {
    ...
    public ResponseEntity<TeamOwner> updateTeamOwner(@RequestBody TeamOwner teamOwner) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, teamOwner.getId().toString()))
            .body(result);
    }
